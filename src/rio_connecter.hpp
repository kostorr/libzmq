...
#ifndef __ZMQ_RIO_CONNECTER_HPP_INCLUDED__
#define __ZMQ_RIO_CONNECTER_HPP_INCLUDED__
...
namespace zmq
{
    ...
    class rio_connecter_t : public own_t, public io_object_t
    {
    public:

        // if 'delayed_start' is true connecter first waits for a while then starts connection process.
        rio_connecter_t (zmq::io_thread_t * io_thread_,
    ...
    private:
        ...
        // Open a RapidIO connecting socket. Return -1 in case of error,
        // 0 if connect was succesful immediately. Returns -1 with
        ...
        // If trre, connecter will wait for a while before trying to connect
        ...
        rio_connecter_t (const rio_connecter_t&);
        const rio_connecter_t &operator = (const rio_connecter_t&);
    };
}
